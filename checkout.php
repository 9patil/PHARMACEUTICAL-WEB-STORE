...
if (isset($_POST['order'])) {
   ...
   $address = ' ' . $_POST['flat'] . ' , ' . $_POST['Landmark'] . ' , ' . $_POST['city'] . ' , ' . $_POST['state'] . ' ' . $_POST['country'] . ' - ' . $_POST['pin_code'];
   ...
   <section class="checkout-orders">
      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Landmark :</span>
               <input type="text" name="Landmark" placeholder="e.g. Near Post Office" class="box">
            </div>
            <div class="inputBox">
               <span>city :</span>
